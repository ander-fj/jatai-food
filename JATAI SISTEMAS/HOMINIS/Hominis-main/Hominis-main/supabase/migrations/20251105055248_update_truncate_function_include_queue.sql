/*
  # Atualizar função truncate_all_data para incluir tabela de recálculos

  Atualização: Adiciona a exclusão dos dados da tabela ranking_recalculation_queue
  ao executar a função de limpeza completa do sistema.

  Tabelas afetadas:
    - ranking_recalculation_queue (nova)
  
  Ordem de exclusão mantida respeitando foreign keys.
*/
