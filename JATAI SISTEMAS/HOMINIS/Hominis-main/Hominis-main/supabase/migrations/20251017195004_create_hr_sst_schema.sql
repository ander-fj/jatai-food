/*
  ...
  - Policies for authenticated users to manage their organization's data
*/
...
-- RLS Policies for authenticated users (allowing full access for demo purposes)
...
CREATE POLICY "Allow all operations for authenticated users on evaluation_criteria"
  ON evaluation_criteria FOR ALL
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow all operations for authenticated users on employee_scores"
  ON employee_scores FOR ALL
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow all operations for authenticated users on employee_rankings"
  ON employee_rankings FOR ALL
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow all operations for authenticated users on sst_trainings"
  ON sst_trainings FOR ALL
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow all operations for authenticated users on sst_ppe"
  ON sst_ppe FOR ALL
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow all operations for authenticated users on sst_medical_exams"
  ON sst_medical_exams FOR ALL
  TO authenticated
  USING (true)
  WITH CHECK (true);

CREATE POLICY "Allow all operations for authenticated users on sst_incidents"
...
CREATE POLICY "Allow all operations for authenticated users on sheets_sync_config"
